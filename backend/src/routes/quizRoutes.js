...
router.get('/quiz/:quizId/check-attempt', authMiddleware, quizController.checkUserAttempt);

// Submit quiz response (user)
router.post('/submit', authMiddleware, quizController.submitQuizResponse);

// Get user's specific quiz response
router.get('/response/:responseId', authMiddleware, quizController.getUserQuizResponse);

// Get user's all quiz responses
router.get('/my-responses', authMiddleware, quizController.getUserAllResponses);
